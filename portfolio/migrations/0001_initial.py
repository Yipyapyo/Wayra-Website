# Generated by Django 4.1.2 on 2023-03-17 14:14
...
class Migration(migrations.Migration):
    ...
    operations = [
                    ...
                    models.DateField(
                        validators=[
                            django.core.validators.MaxValueValidator(
                                limit_value=datetime.date(2023, 3, 17)
                            )
                        ]
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to=portfolio.models.document_model.get_path,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            managers=[("objects", portfolio.models.manager.UserManager()),],
        ),
        migrations.CreateModel(
            name="Programme",
            fields=[
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    models.Q(("file__gt", ""), ("url__isnull", True)),
                    models.Q(("file__exact", ""), ("url__isnull", False)),
                    _connector="OR",
                ),
                name="portfolio_document_url_or_file",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="programme", unique_together={("name", "cohort")},
        ),
    ]
