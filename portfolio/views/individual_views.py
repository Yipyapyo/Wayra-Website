...
def individual_create(request):
    ...
    if request.method == "POST":
        ...
        if individual_form.is_valid() and address_forms.is_valid() and all([pf.is_valid() for pf in past_experience_forms]) and founder_form.is_valid():
            new_individual = individual_form.save(commit=False)
...
def individual_update(request, id):
    ...
    founder_form = individual_form.founder
    ...
    if request.method == 'POST':
        ...
        form4 = FounderForm(request.POST, instance=founder_form, prefix="form4")
        ...
        if individual_form.isFounder:
            form1 = FounderForm(instance=individual_form.founder, prefix="form1")
        else:
            ...
            form4 = IndividualCreateForm(instance=individual_form, prefix="form4")
    context = {
